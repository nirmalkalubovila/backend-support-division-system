...
router
  .route('/')
  .post(auth('projects.project.create'), validate(projectValidation.createProject), activityLogger('Create project'), projectController.createProject)
...
router
  ...
  .patch(auth('projects.project.update'), validate(projectValidation.updateProject), activityLogger('Update project'), projectController.updateProject)
